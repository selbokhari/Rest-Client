            ...
            <div class="container-login100" >
                ...
                <div class="d">  
                    ...
                    <div class="bordder nonBorder">
                        <font color="white" size=+3>Moyenne d'un semestre</font><br><br><br>
                        <form  action="moyenneSemestre">
                            ...
                            <input class="login100-form-btn  button2 button" type='submit' value='Voir la moyenne'><br>
                        </form><br>  
                        <h1>${moyenne}</h1>
