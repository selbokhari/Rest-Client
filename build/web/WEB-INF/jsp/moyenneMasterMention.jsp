...
<!--
                        <font color="white" size=+3>Moyenne d'une année</font><br><br><br>
                        <form  action="moyenneAnnée">
                            <%  List<Etudiant> etudiants1 = ControllerMapping.getEtudiants(); %>
                            <label for="idE">Etudiant</label>
                            <select id="idE" name="idE">
                                <option selected ></option>
                                <%for (Etudiant e : etudiants1) {%>   
                                <option value="<%=e.getIdetudiant()%>"> <%=e.getNom() + " " + e.getPrenom()%></option>
                                <% }%>   
                            </select> 

                            <label for="idA">Année</label>
                            <select id="idA" name="idA"><br><br>
                                <option value="1">Première Année</option>
                                <option value="2">Deuxième Année</option>
                            </select><br><br>

                            <input class="login100-form-btn  button2 button" type='submit' value="Voir la moyenne d'une année" ><br>
                        </form><br><br><br>    
                        <h1>${moyenne}</h1>-->

                        <font color="white" size=+3>Voir la moyenne et la mention du master d'un étudiant</font><br><br><br>


                        <form  action="moyenneMasterMention">
