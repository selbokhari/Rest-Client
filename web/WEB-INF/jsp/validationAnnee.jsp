            ...
            <div class="container-login100" >
                ...
                <div class="d">  
                    ...
                    <div class="bordder nonBorder">
                        ...
                        <!--
                                                <font color="white" size=+3>La vérification de la validation d'un semestre</font><br><br><br>
                        
                                                <form  action="validationSemestre">
                        <%  List<Etudiant> etudiants2 = ControllerMapping.getEtudiants();  %>
                        <label for="idE">Etudiant</label>
                        <select id="idE" name="idE">
                            <option selected ></option>
                        <%for (Etudiant e : etudiants2) {%>   
                ...
                <h1>${moyenne}</h1>-->
                        ...
                        <!--<h1>La vérification de la validation d'une année</h1>-->
                        <font color="white" size=+2>La vérification de la validation d'une année</font><br><br>

                        <form  action="validationAnnee">
                            <%  List<Etudiant> etudiants = ControllerMapping.getEtudiants();  %>
                            <label for="idE">Etudiant</label>
                            <select id="idE" name="idE" required="true">
                                <option selected ></option>
                            ...
                            <select id="idA" name="idA" required="true">
                                <option value="" ></option>
                                <option value="1" >Première Année</option>
                                <option value="2">Deuxième Année</option>
                            </select>

                            <input class="login100-form-btn  button2 button" type='submit' value="Vérifier" >
                        </form><br><br> 
                        <h1>${moyenne}</h1>
                    </div>
